...
namespace DOAN_QLBH.DAL
{
    class LOPDUNGCHUNG
    {
        ...
        public LOPDUNGCHUNG()
        {
            conn.ConnectionString = @"Data Source=DESKTOP-RBCOQHH;Initial Catalog=ZERO;Integrated Security=True";
         
        }
        public SqlConnection connection()
        {
            SqlConnection conn = new SqlConnection(@"Data Source=DESKTOP-RBCOQHH;Initial Catalog=ZERO;Integrated Security=True");
